...
fn to_uppercase_high() {
    ...
    to_uppercase_high_batch_test!(i128::max_value(), "壹佰柒拾萬壹仟肆佰壹拾壹京捌仟參佰肆拾陸萬零肆佰陸拾玖億貳仟參佰壹拾柒萬參仟壹佰陸拾捌兆柒仟參佰零參萬柒仟壹佰伍拾捌億捌仟肆佰壹拾萬伍仟柒佰貳拾柒");
    to_uppercase_high_batch_test!(i128::min_value(), "負壹佰柒拾萬壹仟肆佰壹拾壹京捌仟參佰肆拾陸萬零肆佰陸拾玖億貳仟參佰壹拾柒萬參仟壹佰陸拾捌兆柒仟參佰零參萬柒仟壹佰伍拾捌億捌仟肆佰壹拾萬伍仟柒佰貳拾捌");
    to_uppercase_high_batch_test!(u128::max_value(), "參佰肆拾萬貳仟捌佰貳拾參京陸仟陸佰玖拾貳萬零玖佰參拾捌億肆仟陸佰參拾肆萬陸仟參佰參拾柒兆肆仟陸佰零柒萬肆仟參佰壹拾柒億陸仟捌佰貳拾壹萬壹仟肆佰伍拾伍");
}
...
fn to_lowercase_high() {
    ...
    to_lowercase_high_batch_test!(i128::max_value(), "一百七十萬一千四百一十一京八千三百四十六萬零四百六十九億二千三百一十七萬三千一百六十八兆七千三百零三萬七千一百五十八億八千四百一十萬五千七百二十七");
    to_lowercase_high_batch_test!(i128::min_value(), "負一百七十萬一千四百一十一京八千三百四十六萬零四百六十九億二千三百一十七萬三千一百六十八兆七千三百零三萬七千一百五十八億八千四百一十萬五千七百二十八");
    to_lowercase_high_batch_test!(u128::max_value(), "三百四十萬二千八百二十三京六千六百九十二萬零九百三十八億四千六百三十四萬六千三百三十七兆四千六百零七萬四千三百一十七億六千八百二十一萬一千四百五十五");
}
