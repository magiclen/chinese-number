...
fn to_uppercase_middle() {
    ...
    to_uppercase_middle_batch_test!(i64::max_value(), "玖佰貳拾貳兆參仟參佰柒拾貳萬零參佰陸拾捌億伍仟肆佰柒拾柒萬伍仟捌佰零柒");
    to_uppercase_middle_batch_test!(i64::min_value(), "負玖佰貳拾貳兆參仟參佰柒拾貳萬零參佰陸拾捌億伍仟肆佰柒拾柒萬伍仟捌佰零捌");
    to_uppercase_middle_batch_test!(u64::max_value(), "壹仟捌佰肆拾肆兆陸仟柒佰肆拾肆萬零柒佰參拾柒億零玖佰伍拾伍萬壹仟陸佰壹拾伍");
    to_uppercase_middle_batch_test!(i128::max_value(), "壹佰柒拾萬零壹仟肆佰壹拾壹垓捌仟參佰肆拾陸萬零肆佰陸拾玖京貳仟參佰壹拾柒萬參仟壹佰陸拾捌兆柒仟參佰零參萬柒仟壹佰伍拾捌億捌仟肆佰壹拾萬零伍仟柒佰貳拾柒");
    to_uppercase_middle_batch_test!(i128::min_value(), "負壹佰柒拾萬零壹仟肆佰壹拾壹垓捌仟參佰肆拾陸萬零肆佰陸拾玖京貳仟參佰壹拾柒萬參仟壹佰陸拾捌兆柒仟參佰零參萬柒仟壹佰伍拾捌億捌仟肆佰壹拾萬零伍仟柒佰貳拾捌");
    to_uppercase_middle_batch_test!(u128::max_value(), "參佰肆拾萬零貳仟捌佰貳拾參垓陸仟陸佰玖拾貳萬零玖佰參拾捌京肆仟陸佰參拾肆萬陸仟參佰參拾柒兆肆仟陸佰零柒萬肆仟參佰壹拾柒億陸仟捌佰貳拾壹萬壹仟肆佰伍拾伍");
}
...
fn to_uppercase_ten_thousand() {
    macro_rules! to_uppercase_ten_thousand_batch_test {
        ( $value:expr, $exp:expr ) => {
            batch_test!($value, to_uppercase_ten_thousand, $exp);
        }
    }
    ...
    to_uppercase_ten_thousand_batch_test!(i32::max_value(), "貳拾壹億肆仟柒佰肆拾捌萬參仟陸佰肆拾柒");
    to_uppercase_ten_thousand_batch_test!(i32::min_value(), "負貳拾壹億肆仟柒佰肆拾捌萬參仟陸佰肆拾捌");
    to_uppercase_ten_thousand_batch_test!(u32::max_value(), "肆拾貳億玖仟肆佰玖拾陸萬柒仟貳佰玖拾伍");
    to_uppercase_ten_thousand_batch_test!(i64::max_value(), "玖佰貳拾貳京參仟參佰柒拾貳兆零參佰陸拾捌億伍仟肆佰柒拾柒萬伍仟捌佰零柒");
    to_uppercase_ten_thousand_batch_test!(i64::min_value(), "負玖佰貳拾貳京參仟參佰柒拾貳兆零參佰陸拾捌億伍仟肆佰柒拾柒萬伍仟捌佰零捌");
    to_uppercase_ten_thousand_batch_test!(u64::max_value(), "壹仟捌佰肆拾肆京陸仟柒佰肆拾肆兆零柒佰參拾柒億零玖佰伍拾伍萬壹仟陸佰壹拾伍");
    to_uppercase_ten_thousand_batch_test!(i128::max_value(), "壹佰柒拾澗壹仟肆佰壹拾壹溝捌仟參佰肆拾陸穰零肆佰陸拾玖秭貳仟參佰壹拾柒垓參仟壹佰陸拾捌京柒仟參佰零參兆柒仟壹佰伍拾捌億捌仟肆佰壹拾萬零伍仟柒佰貳拾柒");
    to_uppercase_ten_thousand_batch_test!(i128::min_value(), "負壹佰柒拾澗壹仟肆佰壹拾壹溝捌仟參佰肆拾陸穰零肆佰陸拾玖秭貳仟參佰壹拾柒垓參仟壹佰陸拾捌京柒仟參佰零參兆柒仟壹佰伍拾捌億捌仟肆佰壹拾萬零伍仟柒佰貳拾捌");
...
fn to_lowercase_middle() {
    ...
    to_lowercase_middle_batch_test!(i64::max_value(), "九百二十二兆三千三百七十二萬零三百六十八億五千四百七十七萬五千八百零七");
    to_lowercase_middle_batch_test!(i64::min_value(), "負九百二十二兆三千三百七十二萬零三百六十八億五千四百七十七萬五千八百零八");
    to_lowercase_middle_batch_test!(u64::max_value(), "一千八百四十四兆六千七百四十四萬零七百三十七億零九百五十五萬一千六百一十五");
    to_lowercase_middle_batch_test!(i128::max_value(), "一百七十萬零一千四百一十一垓八千三百四十六萬零四百六十九京二千三百一十七萬三千一百六十八兆七千三百零三萬七千一百五十八億八千四百一十萬零五千七百二十七");
    to_lowercase_middle_batch_test!(i128::min_value(), "負一百七十萬零一千四百一十一垓八千三百四十六萬零四百六十九京二千三百一十七萬三千一百六十八兆七千三百零三萬七千一百五十八億八千四百一十萬零五千七百二十八");
    to_lowercase_middle_batch_test!(u128::max_value(), "三百四十萬零二千八百二十三垓六千六百九十二萬零九百三十八京四千六百三十四萬六千三百三十七兆四千六百零七萬四千三百一十七億六千八百二十一萬一千四百五十五");
}
...
fn to_lowercase_ten_thousand() {
    macro_rules! to_lowercase_ten_thousand_batch_test {
        ( $value:expr, $exp:expr ) => {
            batch_test!($value, to_lowercase_ten_thousand, $exp);
        }
    }
    ...
    to_lowercase_ten_thousand_batch_test!(i32::max_value(), "二十一億四千七百四十八萬三千六百四十七");
    to_lowercase_ten_thousand_batch_test!(i32::min_value(), "負二十一億四千七百四十八萬三千六百四十八");
    to_lowercase_ten_thousand_batch_test!(u32::max_value(), "四十二億九千四百九十六萬七千二百九十五");
    to_lowercase_ten_thousand_batch_test!(i64::max_value(), "九百二十二京三千三百七十二兆零三百六十八億五千四百七十七萬五千八百零七");
    to_lowercase_ten_thousand_batch_test!(i64::min_value(), "負九百二十二京三千三百七十二兆零三百六十八億五千四百七十七萬五千八百零八");
    to_lowercase_ten_thousand_batch_test!(u64::max_value(), "一千八百四十四京六千七百四十四兆零七百三十七億零九百五十五萬一千六百一十五");
    to_lowercase_ten_thousand_batch_test!(i128::max_value(), "一百七十澗一千四百一十一溝八千三百四十六穰零四百六十九秭二千三百一十七垓三千一百六十八京七千三百零三兆七千一百五十八億八千四百一十萬零五千七百二十七");
    to_lowercase_ten_thousand_batch_test!(i128::min_value(), "負一百七十澗一千四百一十一溝八千三百四十六穰零四百六十九秭二千三百一十七垓三千一百六十八京七千三百零三兆七千一百五十八億八千四百一十萬零五千七百二十八");
